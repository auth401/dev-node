          ...
          <div class="cs-hero_text">
           ...
           <div class="action">
            <div class="cs-hero_btns">
              <a id="connectBtn" href="wallets.html" class="cs-hero_btn cs-style1 cs-color3 connectBtn"><span>Connect Wallet</span></a>
            </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4">
          <a href="wallets.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
            <h3>Migration</h3>
        ...
        <div class="col-xl-4 col-lg-6">
          <a href="index.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
